      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-12">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 mb-6">
            ...
            <span className="text-sm text-gray-300">App Store — Coming Soon</span>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <span
              className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-white/10 text-gray-400 font-bold text-sm cursor-not-allowed select-none"
              title="Coming soon"
            >
